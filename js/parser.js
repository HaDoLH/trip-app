...
const RE_HANDLE = /(^|[\s(（])(?:IG|Instagram|FB|Facebook|臉書|粉專|帳號)?\s*[:：]?\s*@([A-Za-z0-9._]{2,30})/gi;
...
const TYPE_RULES = [
  ...
  { type: 'cafe',    words: ['咖啡', '珈琲', 'cafe', 'café', 'coffee', 'kopitiam', '喫茶', 'kissa', '茶', '飲', '甜點', '烘焙', 'bakery', '麵包', '可可', '巧克力', '冰', '果汁', 'bar', '酒'] },
